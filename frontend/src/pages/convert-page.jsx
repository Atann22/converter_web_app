...
export default function ConvertPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-6 sm:py-13 -mt-6 sm:-mt-8">
            <h1 className="text-lg sm:text-3xl font-bold mb-1 text-slate-800 dark:text-slate-100 text-center">Convert Image</h1>
            <p className="text-xs mb-5 sm:text-sm font-medium text-slate-600 dark:text-slate-400 text-center">Upload an image and convert it to JPG, PNG, or WEBP in seconds.</p>
