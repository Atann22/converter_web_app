...
export default function ConvertPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto px-8 sm:px-4 py-20 sm:py-20">
            <h1 className="text-2xl sm:text-3xl font-bold mb-1 text-slate-800 dark:text-slate-100 text-center">Convert Image</h1>
            <p className="text-sm sm:text-base mb-5 font-medium text-slate-600 dark:text-slate-400 text-center">Upload an image and convert it to JPG, PNG, or WEBP in seconds.</p>
                    ...
                    {resultUrl ? (
                        <div className="w-full min-h-65 sm:min-h-80 flex flex-col items-center justify-center border border-dashed border-slate-200 dark:border-slate-700 rounded-2xl bg-slate-50/50 dark:bg-slate-950/40 p-6">
                            <div className="w-full max-h-45 overflow-hidden rounded-xl flex items-center justify-center mb-4 shadow-sm bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 p-1">
                                <img src={resultUrl || preview || ""} alt="Preview" className="max-w-full max-h-42.5 object-contain rounded-lg" />
                            </div>
                                        ...
                                        <div className="absolute left-0 mt-1.5 w-full bg-white dark:bg-slate-950 rounded-xl shadow-xl border border-slate-100 dark:border-slate-800 py-1.5 z-20 text-center">
                                            {formatOptions.map((opt) => (
                                                <button
                                                    ...
                                                    className={`w-full text-center px-4 py-2.5 text-xs sm:text-sm font-bold uppercase transition-all block cursor-pointer ${format === opt
